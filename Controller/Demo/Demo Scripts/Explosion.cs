    ...
    public class Explosion : MonoBehaviour {
        ...
        private void OnTriggerEnter2D(Collider2D other) {
            if (other.TryGetComponent(out IPlayerController controller)) {
                ...
                controller.ApplyVelocity(-incomingSpeed, UnitForce.Burst); // cancel current incoming speed for more consistent bounces
                controller.SetVelocity(dir.normalized * _explosionForce, UnitForce.Decay);
            }
        }
